    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <main className="container mx-auto px-4 py-6 md:py-8">
        ...
        <div className="mb-4 text-xs text-gray-400 dark:text-gray-500">
          ...
          <span className="text-gray-600 dark:text-gray-400">Pesquisa</span>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <aside className={`w-full md:w-56 shrink-0 ${showFilters ? "block" : "hidden md:block"}`}>
            <div className="sticky top-24 space-y-5">
              ...
              {/* Category */}
              <div>
                <h3 className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-2">Categoria</h3>
              ...
              {/* Gender */}
              <div>
                <h3 className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-2">Género</h3>
                <div className="flex flex-wrap gap-1.5">
                  {GENDERS.map((g) => (
                    <button
                      key={g.value}
          ...
          <div className="flex-1 min-w-0">
            {isLoading ? (
              <div className="flex flex-col items-center justify-center py-20 gap-3">
                ...
                <p className="text-sm text-gray-400 dark:text-gray-500">A procurar...</p>
              </div>
            ) : results.length > 0 ? (
              ...
              <div className="py-16 text-center">
                ...
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                  {query
                    ? "Tenta com outras palavras ou ajusta os filtros"
