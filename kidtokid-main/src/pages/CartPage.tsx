    ...
    return (
      <div className="min-h-screen flex flex-col bg-white dark:bg-gray-950">
        ...
        <main className="flex-1 flex flex-col items-center justify-center py-20 px-4 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">O teu carrinho está vazio</h1>
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-gray-950">
      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-4xl">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">
            Carrinho <span className="text-gray-400 dark:text-gray-500 font-normal text-base ml-1">({items.length})</span>
          </h1>
          ...
          <div className="lg:col-span-2 space-y-0">
            ...
            <div className="mb-4">
              <div className="flex items-center justify-between mb-1.5 text-sm">
                ...
                <span className="text-gray-400 dark:text-gray-500 text-xs">{Math.round(progressToFreeShipping)}%</span>
              </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex justify-between items-start gap-2">
                        ...
                        <p className="font-semibold text-gray-900 dark:text-gray-100 whitespace-nowrap">€{(item.product.price * item.quantity).toFixed(2)}</p>
                      </div>
                      ...
                      <div className="flex items-center justify-between mt-3">
                        <div className="flex items-center border border-gray-200 dark:border-gray-700 rounded h-8">
                          <button
                            ...
                            className="px-2.5 h-full flex items-center hover:bg-gray-50 dark:hover:bg-gray-800 text-gray-500 dark:text-gray-400 disabled:opacity-30 transition-colors"
                          >
                        ...
                        <div className="flex items-center gap-1">
                          {!isFavorite(item.product.id) && (
                            <button
                              className="p-1.5 text-gray-400 dark:text-gray-500 hover:text-pink-500 transition-colors"
            ...
            <div className="flex justify-end mt-2">
              <button onClick={handleClearCart} className="text-xs text-gray-400 dark:text-gray-500 hover:text-red-500 transition-colors py-1">
                Esvaziar carrinho
              </button>
            </div>
          </div>
          ...
          <div className="lg:sticky lg:top-24">
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-5">
              ...
              <div className="space-y-3 text-sm">
                ...
                {totalPrice < freeShippingThreshold && (
                  <p className="text-xs text-blue-600 bg-blue-50 dark:bg-blue-950/30 p-2 rounded text-center">
                ...
                <div className="border-t pt-3 mt-3 flex justify-between items-end">
                  ...
                  <div className="text-right">
                    <span className="block font-bold text-xl text-gray-900 dark:text-gray-100">€{(totalPrice + shippingCost + protectionFee).toFixed(2)}</span>
                    <span className="text-xs text-gray-400 dark:text-gray-500">IVA incluído</span>
                  </div>
                </div>
              </div>
      ...
      <ConfirmDialog
        ...
        description="Tens a certeza que queres remover todos os artigos do carrinho?"
