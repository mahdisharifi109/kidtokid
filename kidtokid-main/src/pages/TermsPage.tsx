            ...
            <main className="container mx-auto px-4 py-8 md:py-14 max-w-3xl">
                ...
                <div className="mb-10 pb-10 border-b border-gray-100 dark:border-gray-800">
                    <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                        Estas condições são entre nós, a <strong className="text-gray-900 dark:text-gray-100">Kid to Kid Braga</strong> (Rua do Raio, 9,
                ...
                <div className="space-y-10">
                    ...
                    <section>
                        ...
                        <div className="mt-4 bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-700 rounded-lg p-4">
                    ...
                    <section>
                        ...
                        <div className="text-gray-600 dark:text-gray-400 leading-relaxed space-y-3">
                            <p>
                                É simples: escolhe os artigos no nosso site e faça a encomenda online.
                            </p>
                            <p>
                    ...
                    <section>
                        ...
                        <div className="mt-4 grid gap-3 sm:grid-cols-2">
                            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 text-center">
                                <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Compras até 49,99€</p>
                                <p className="text-xl font-bold text-gray-900 dark:text-gray-100">4,50€</p>
                            </div>
                            <div className="bg-green-50 dark:bg-green-950/30 rounded-lg p-4 text-center">
                                <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Compras +50€</p>
                    ...
                    <section>
                        ...
                        <p className="font-medium text-gray-900 dark:text-gray-100 mt-4 mb-3 text-sm">Pode pagar com:</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                            <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                                <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-1.5 text-sm">Multibanco</h4>
                                <p className="text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                                <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-1.5 text-sm">MB Way</h4>
                                <p className="text-sm text-gray-500 dark:text-gray-400">
                                    Introduz o teu número MB Way e confirma o pedido de pagamento na app.
                                </p>
                            </div>
                        </div>
                    ...
                    <section>
                        ...
                        <div className="text-gray-600 dark:text-gray-400 leading-relaxed space-y-3">
                            <p>
                                Depois de receber a encomenda, tem <strong className="text-gray-900 dark:text-gray-100">14 dias</strong> para devolver
                                qualquer artigo.
                            </p>
                        </div>

                        <p className="font-medium text-gray-900 dark:text-gray-100 mt-4 mb-3 text-sm">Para devolver, basta garantir que:</p>
                        <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <li className="flex items-start gap-2">
                                ...
                                <span>Os portes de devolução são por tua conta (exceto quando a responsabilidade é nossa)</span>
                            </li>
                            <li className="flex items-start gap-2">
                        ...
                        <div className="mt-4 bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                            <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Morada para devoluções</p>
                            <p className="text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <section>
                        ...
                        <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                            ...
                            dos produtos. <strong className="text-gray-900 dark:text-gray-100">Guarde sempre a fatura durante todo o período de garantia.</strong>
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="text-gray-600 dark:text-gray-400 leading-relaxed space-y-3">
                            <p>
                                Os teus dados são tratados com todo o cuidado, ao abrigo do RGPD.
                                Usamos as informações apenas para processar encomendas, comunicar consigo
                                e melhorar a tua experiência.
                            </p>
                            <p>
                                Tem sempre o direito de aceder e corrigir os teus dados.
                            </p>
                        </div>
                        <Link
                ...
                <div className="mt-12 pt-10 border-t border-gray-200 dark:border-gray-700">
                    <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Precisa de ajuda?</h2>
                    ...
                    <div className="grid gap-4 sm:grid-cols-3">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <a href="tel:+351253215379" className="text-sm text-gray-700 dark:text-gray-300 hover:text-blue-600">
                                    +351 253 215 379
                                </a>
                            </div>
                        </div>
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <a href="mailto:braga@kidtokid.pt" className="text-sm text-gray-700 dark:text-gray-300 hover:text-blue-600">
                                    braga@kidtokid.pt
                                </a>
                            </div>
                        </div>
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-700 dark:text-gray-300">Rua do Raio, 9, Braga</p>
                            </div>
                        </div>
                    </div>
                </div>
