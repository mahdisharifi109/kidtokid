    ...
    return (
        <AdminLayout title="Analytics" subtitle="Métricas e desempenho da loja">
                ...
                <Card className="p-4">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-xs text-gray-400 mt-1">{paidOrders.length} pagas</p>
                        </div>
                ...
                <Card className="p-4">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-xs text-gray-400 mt-1">{totalItems} artigos vendidos</p>
                        </div>
                ...
                <Card className="p-4">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-xs text-gray-400 mt-1">{data.totalNewsletter} newsletter</p>
                        </div>
            ...
            <div className="grid lg:grid-cols-3 gap-6">
                ...
                {/* Order Status */}
                <Card className="p-6">
                    <h3 className="font-semibold text-gray-900 mb-4">Estado das Encomendas</h3>
                ...
                <Card className="p-6">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            ...
                            <span className="font-bold text-gray-900">{data.totalProducts}</span>
                        </div>
                        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div className="flex items-center gap-2 text-sm text-gray-600">
                            ...
                            <span className="font-bold text-gray-900">{data.totalReviews}</span>
                        </div>
                        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div className="flex items-center gap-2 text-sm text-gray-600">
                            ...
                            <span className="font-bold text-gray-900">{conversionEstimate}%</span>
                        </div>
                        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div className="flex items-center gap-2 text-sm text-gray-600">
                            ...
                            <span className="font-bold text-gray-900">{data.totalNewsletter}</span>
                        </div>
                    </div>
                </Card>
            </div>
