      ...
      <main className="container mx-auto px-4 py-8 md:py-14 max-w-4xl">
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div className="text-gray-600 dark:text-gray-400 leading-relaxed space-y-4">
              <p>
                ...
                e ainda colocar dinheiro no teu bolso.
              </p>
              <p>
                Na Kid to Kid, tratamos cada peça com o mesmo carinho que a tua família lhe deu.
                Traga-nos o calçado, a roupa e os brinquedos que já não usam — avaliamos tudo na hora.
              </p>
            </div>
            <div>
              <p className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-3">Neste momento procuramos:</p>
        ...
        <section className="mb-12 md:mb-16">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-5">
              <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-2">Laços de todas as cores</h3>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-5">
              <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-2">Clube do Livro</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
        ...
        <section className="mb-12 md:mb-16">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <div>
              <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-1.5">Sustentabilidade</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                Cada peça que ganha uma nova vida é menos desperdício. Cuidamos do planeta para os nossos filhos.
              </p>
            </div>
            <div>
              <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-1.5">Qualidade</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                Analisamos todos os artigos com atenção. Se não está em bom estado, não entra na loja.
              </p>
            </div>
            <div>
              <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-1.5">Comunidade</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
        ...
        <section className="mb-12 md:mb-16">
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            {/* Mapa */}
            <div className="rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 h-72 md:h-80">
              <iframe
            ...
            <div className="space-y-5">
              <div className="flex items-start gap-3">
                <MapPin className="h-4 w-4 text-gray-400 dark:text-gray-500 shrink-0 mt-1" />
                <div>
                  <p className="text-sm font-medium text-gray-900 dark:text-gray-100">Morada</p>
              ...
              <div className="flex items-start gap-3">
                <Phone className="h-4 w-4 text-gray-400 dark:text-gray-500 shrink-0 mt-1" />
                <div>
                  <p className="text-sm font-medium text-gray-900 dark:text-gray-100">Telefone</p>
                  <a href="tel:+351253215379" className="text-sm text-gray-500 dark:text-gray-400 hover:text-blue-600">
                    +351 253 215 379
                  </a>
                  <p className="text-xs text-gray-400 dark:text-gray-500">Chamada para rede fixa nacional</p>
                </div>
              </div>

              <div className="flex items-start gap-3">
                <Mail className="h-4 w-4 text-gray-400 dark:text-gray-500 shrink-0 mt-1" />
                <div>
                  <p className="text-sm font-medium text-gray-900 dark:text-gray-100">Email</p>
                  <a href="mailto:info@kidtokid.pt" className="text-sm text-gray-500 dark:text-gray-400 hover:text-blue-600">
                    info@kidtokid.pt
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                <Clock className="h-4 w-4 text-gray-400 dark:text-gray-500 shrink-0 mt-1" />
                <div>
                  <p className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-1.5">Horário</p>
        ...
        <section className="pt-8 border-t border-gray-100 dark:border-gray-800">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-1">Pagamentos seguros</h2>
          ...
          <div className="flex flex-wrap gap-3">
            {["Multibanco", "MB Way", "Cartão", "Dinheiro (na loja)"].map((method) => (
              <span
                key={method}
                className="text-sm text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-4 py-2"
              >
                {method}
              </span>
            ))}
