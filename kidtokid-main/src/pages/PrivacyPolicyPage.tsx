      ...
      <main className="container mx-auto px-4 py-8 md:py-14 max-w-3xl">
        ...
        <div className="mb-10 md:mb-14">
          ...
          <p className="text-gray-500 text-base md:text-lg leading-relaxed">
            Explicamos como cuidamos dos seus dados de forma clara e sem complicações.
          </p>
        ...
        <div className="mb-10 pb-10 border-b border-gray-100">
          ...
          <p className="text-gray-600 leading-relaxed">
            A sua confiança é o nosso bem mais precioso.
          </p>
        </div>
        ...
        <div className="space-y-10">
          ...
          {/* Compromisso */}
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">A nossa promessa</h2>
            <div className="text-gray-600 leading-relaxed space-y-3">
              <p>
                Cuidar dos seus dados é tão importante para nós como cuidar dos artigos que vendemos.
                Só usamos aquilo que é necessário para lhe dar o melhor serviço, com total transparência.
              </p>
              <p>
                Quando os seus dados são tratados por parceiros nossos, exigimos-lhes exatamente o mesmo
          ...
          {/* Responsável */}
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">Quem cuida dos seus dados?</h2>
            <p className="text-gray-600 leading-relaxed">
              A <strong className="text-gray-900">Kid to Kid Braga</strong>, com morada na Rua do Raio, 9, 4710-926 Braga.
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">O que guardamos e porquê</h2>
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  text: "Nome e contacto para enviar promoções — mas só com a sua permissão. Pode cancelar a qualquer momento."
                },
                {
                  title: "Após a Compra",
                ...
                },
                {
                  ...
                  text: "Nome, email e telemóvel para podermos responder à sua opinião."
                }
              ].map((item, idx) => (
          ...
          {/* Conservação */}
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">Quanto tempo guardamos os dados?</h2>
            <div className="text-gray-600 leading-relaxed space-y-3">
              <p>
              ...
              <p>
                ...
                De resto, assim que tudo estiver tratado, apagamos os seus dados.
              </p>
          ...
          {/* Partilha */}
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">Com quem partilhamos os dados?</h2>
            <div className="text-gray-600 leading-relaxed space-y-3">
              <p>
              ...
              <p className="font-medium text-gray-900">
                Nunca vendemos nem partilhamos os seus dados com outras empresas para fins comerciais.
              </p>
            </div>
          </section>
          ...
          {/* Direitos */}
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">Os seus direitos</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Tem vários direitos sobre os seus dados e nós respeitamos todos:
            </p>
          ...
          <section>
            ...
            <div className="space-y-3">
              <div className="bg-gray-50 rounded-lg p-4">
                <p className="text-sm font-medium text-gray-900 mb-1">Cookies de Sessão</p>
                <p className="text-sm text-gray-500">
                  Temporários — desaparecem quando fecha o navegador.
                </p>
              </div>
              <div className="bg-gray-50 rounded-lg p-4">
                <p className="text-sm font-medium text-gray-900 mb-1">Cookies de Análise</p>
                <p className="text-sm text-gray-500">
                  Ajudam-nos a perceber como o site é usado para o podermos melhorar.
                </p>
              </div>
              <div className="bg-gray-50 rounded-lg p-4">
                <p className="text-sm font-medium text-gray-900 mb-1">Cookies Publicitários</p>
                <p className="text-sm text-gray-500">
                  Permitem mostrar conteúdos relevantes com base na sua navegação.
                </p>
              </div>
            </div>
          </section>
          ...
          {/* Segurança */}
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">Como protegemos os seus dados</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <ol className="list-decimal list-inside space-y-1.5 text-sm text-gray-600">
              <li>Acesso restrito — só quem precisa vê os seus dados</li>
